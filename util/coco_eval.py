...
class CocoEvaluator(object):
    ...
    def accumulate(self):
        ...
        for iou_type in self.iou_types:
            ...
            sorted_tuple = ((k, self.predictions[iou_type][k]) for k in sorted_key)
            self.predictions[iou_type] = OrderedDict(sorted_tuple)
...
def loadRes(self, resFile):
    ...
    if "caption" in anns[0]:
        ...
        imgIds = imgIds & set([ann["image_id"] for ann in anns])
